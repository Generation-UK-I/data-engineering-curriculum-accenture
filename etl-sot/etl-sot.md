...
> Distribute exercise file [./exercises](./exercises) folder and the [./handouts/](./handouts/) folder.
...
> Do the "Prep" step of setting up a postgres container from the [../handouts/README.md](../handouts/README.md) file.
>
...
There is also an optional fourth part to do some analysis of the acquired data.

Notes:
Check everyone has understood this
