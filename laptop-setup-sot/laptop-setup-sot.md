...
### Troubleshooting Powershell common problems

- If you see an error mentioning running scripts is disabled whilst trying to use `.ps1` scripts throughout the course, you can run this first to fix:
